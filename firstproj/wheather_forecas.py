...
try:
    ...
    def weather_data(query):
        res = requests.get('http://api.openweathermap.org/data/2.5/weather?' + query + '&APPID=0411467f860125cacb001d94f6649f1f&units=metric');
        return res.json();


    # Body UI
    Frame(w, width=1000, height=50, bg='#2C3E50').place(x=0, y=0)
    ...
    e1 = Entry(w, width=21, fg='white', bg="#2C3E50", border=0)
    ...
    def label(a):
        ...
        Frame(width=500, height=50, bg="#2C3E50").place(x=0, y=0)

        l2 = Label(w, text=str(a), bg="#2C3E50", fg="white")  # upper border
